...
Import-Module "$($workingdir)/custom/esxi-stig-module/vmware-esxi-7.0-stig-module.ps1" -DisableNameChecking -force
...
$inspecPath      = "$($workingdir)/vsphere/7.0/vsphere/inspec/vmware-vsphere-7.0-stig-baseline/esxi/inspec.yml"
$inspecEsxSSH    = "$($workingdir)/custom/esxi-stig-module/vmware-esxi-7.0-stig-inspec/esxi-ssh/"
$reportPath      = "$($workingdir)/Reports/" + $VCSAshortname 

$hostCklTable    = [ordered]@{}
$ansiblePlaybook = "$($workingdir)/custom/esxi-stig-module/vmware-esxi-7.0-stig-ansible/playbook.yml"
