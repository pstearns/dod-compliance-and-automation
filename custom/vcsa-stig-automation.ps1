...
$workingdir     = "/opt/stigtools/dod-compliance-and-automation"
...
$inspecPath      = "$($workingdir)/vsphere/7.0/vcsa/inspec/vmware-vcsa-7.0-stig-baseline"
$ansiblePlaybook = "$($workingdir)/vsphere/7.0/vcsa/ansible/vmware-vcsa-7.0-stig-ansible-hardening/playbook.yml"
$reportPath      = "$($workingdir)/Reports"
...
ln -sf "$($workingdir)/photon/3.0/inspec/vmware-photon-3.0-stig-inspec-baseline"                     "$($workingdir)/vsphere/7.0/vcsa/inspec/vmware-photon-3.0-stig-inspec-baseline"
ln -sf "$($workingdir)/photon/3.0/ansible/vmware-photon-3.0-stig-ansible-hardening/roles/photon3"    "$($workingdir)/vsphere/7.0/vcsa/ansible/vmware-vcsa-7.0-stig-ansible-hardening/roles/photon3"
...
rm -df "$($workingdir)/vsphere/7.0/vcsa/ansible/vmware-vcsa-7.0-stig-ansible-hardening/roles/photon3" "$($workingdir)/vsphere/7.0/vcsa/inspec/vmware-photon-3.0-stig-inspec-baseline"
